...
Public Class HlsMsExchangeDataAccess
    ...
    Public Function MsExchangeActivities(activityDateFrom As Date, activityDateTo As Date) As DataTable
        ...
        Dim e2007 As New CompuMaster.Data.MsExchange.Exchange2007SP1OrHigher(CompuMaster.Data.MsExchange.Exchange2007SP1OrHigher.ExchangeVersion.Exchange2013_SP1, _ExchangeServer)
        ...
        Dim folderMsgRoot As CompuMaster.Data.MsExchange.FolderPathRepresentation = e2007.LookupFolder(WellKnownFolderName.MsgFolderRoot)
        Dim folderRoot As CompuMaster.Data.MsExchange.FolderPathRepresentation = e2007.LookupFolder(WellKnownFolderName.Root)
        Dim Items As Item() = folderRoot.Directory.MailboxItems(searchFilterCollection, itemView)

        'prepare Result table
        Dim Result As New DataTable("MsExchange")
        ...
        For Each entryItem As Item In Items
            If entryItem.Subject = "" AndAlso entryItem.DisplayTo = "" AndAlso entryItem.DisplayCc = "" Then
